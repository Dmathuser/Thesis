...
\author{
  ...
  \hfill David Mathews \hfill Larry D. Pyeatt \hfill\\
...
\begin{figure}
	\begin{center}
		\resizebox{\columnwidth}{!}{\input{images/RL1.pdf_t}}
	\end{center}
	\caption{Reinforcement learning agent and environment.}
	\label{fig:RLagent}
\end{figure}
...
\begin{figure*}
	\begin{center}
	  \includegraphics[scale=0.5]{"images/4-TV.pdf"}
          \hspace{0.5in}
	  \includegraphics[scale=0.5]{"images/1-TV.pdf"}
          \hspace{0.5in}
	  \includegraphics[scale=0.5]{"images/No-TV.pdf"}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=0.5]{"images/Distraction_Rate_4-TV.pdf"}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=0.5]{"images/Distraction_Rate_1-TV.pdf"}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=0.5]{"images/Distraction_Rate_No-TV.pdf"}
	\end{center}
...
\begin{figure}[p]
	\begin{center}
		\includegraphics[scale=0.5]{"images/Missed_States_4-TV.pdf"}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=0.5]{"images/Model_Accuracy_4-TV.pdf"}
	\end{center}
...
\begin{figure}[p]
	\begin{center}
		\includegraphics[scale=0.5]{"images/Missed_States_1-TV.pdf"}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=0.5]{"images/Model_Accuracy_1-TV.pdf"}
	\end{center}
...
\begin{figure}[p]
	\begin{center}
		\includegraphics[scale=0.5]{"images/Missed_States_No-TV.pdf"}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=0.5]{"images/Model_Accuracy_No-TV.pdf"}
	\end{center}
...
\begin{figure}
	\begin{center}
		\subfloat[4-TV EPIG Simulation \label{Fig:DRECEP4TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Distractions_EPIG_4-TV.pdf"}}\hfill
		
		\subfloat[4-TV ETPIG Simulation \label{Fig:DRECET4TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Distractions_ETPIG_4-TV.pdf"}}\hfill
	\end{center}
...
\begin{figure}	
	\begin{center}
		\subfloat[1-TV EPIG Simulation \label{Fig:DRECEP1TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Distractions_EPIG_1-TV.pdf"}}\hfill
		
		\subfloat[1-TV ETPIG Simulation \label{Fig:DRECET1TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Distractions_ETPIG_1-TV.pdf"}}\hfill
	\end{center}
...
\begin{figure}	
	\begin{center}
		\subfloat[No-TV EPIG Simulation \label{Fig:DRECEP0TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Distractions_EPIG_No-TV.pdf"}}\hfill
		
		\subfloat[No-TV ETPIG Simulation \label{Fig:DRECET0TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Distractions_ETPIG_No-TV.pdf"}}\hfill
	\end{center}	
...
\begin{figure}
	\begin{center}
		\subfloat[4-TV EPIG Simulation \label{Fig:EMECEP4TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Missed_States_EPIG_4-TV.pdf"}}\hfill
			
		\subfloat[4-TV ETPIG Simulation \label{Fig:EMECET4TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Missed_States_ETPIG_4-TV.pdf"}}\hfill
	\end{center}
...
\begin{figure}
	\begin{center}
		\subfloat[1-TV EPIG Simulation \label{Fig:EMECEP1TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Missed_States_EPIG_1-TV.pdf"}}\hfill
		\subfloat[1-TV ETPIG Simulation \label{Fig:EMECET1TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Missed_States_ETPIG_1-TV.pdf"}}\hfill
	\end{center}
...
\begin{figure}
	\begin{center}
		\subfloat[No-TV EPIG Simulation \label{Fig:EMECEP0TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Missed_States_EPIG_No-TV.pdf"}}\hfill
			
		\subfloat[No-TV ETPIG Simulation \label{Fig:EMECET0TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Missed_States_ETPIG_No-TV.pdf"}}\hfill
	\end{center}
...
\begin{figure}
	\begin{center}
		\subfloat[4-TV EPIG Simulation \label{Fig:EAECEP4TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Model_Accuracy_EPIG_4-TV.pdf"}}\hfill
		\subfloat[4-TV ETPIG Simulation \label{Fig:EAECET4TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Model_Accuracy_ETPIG_4-TV.pdf"}}\hfill
	\end{center}
...
\begin{figure}
	\begin{center}
		\subfloat[1-TV EPIG Simulation \label{Fig:EAECEP1TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Model_Accuracy_EPIG_1-TV.pdf"}}\hfill
		\subfloat[1-TV ETPIG Simulation \label{Fig:EAECET1TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Model_Accuracy_ETPIG_1-TV.pdf"}}\hfill
	\end{center}
...
\begin{figure}
	\begin{center}
		\subfloat[No-TV EPIG Simulation \label{Fig:EAECEP0TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Model_Accuracy_EPIG_No-TV.pdf"}}\hfill
		\subfloat[No-TV ETPIG Simulation \label{Fig:EAECET0TV}]{\includegraphics[scale=0.5]{"images/Epsilon_Model_Accuracy_ETPIG_No-TV.pdf"}}\hfill
	\end{center}
